...
('KAREVO-ORG-001', 'Lagos University Teaching Hospital', 'admin@luth.karevo.demo', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1)
ON DUPLICATE KEY UPDATE name=VALUES(name);

INSERT INTO patients (karevo_id, full_name, email, phone, password) VALUES
('KID-PAT-001', 'Wisdom Aso-Ukpai (Demo Patient)', 'wisdom.aso.ukpai@karevo.demo', '+2348000000001', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'),

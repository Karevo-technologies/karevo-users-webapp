...
const STEPS: TourStep[] = [
  {
    id: "welcome",
    title: "Welcome to Karevo 👋",
    body: "Your digital health identity, all in one place. Here's a quick look around; it takes about thirty seconds.",
  },
  {
    id: "nav",
    target: '[data-tour="nav"]',
    title: "Everything lives here",
    body: "Health consents, QR scanning and share tokens. Manage your identity from one place.",
  },
  {
    id: "menu",
    target: '[data-tour="menu"]',
    title: "Your menu",
    body: "Consents, scanning and share tokens all live in here — always within thumb's reach.",
  },
  {
    id: "search",
    target: '[data-tour="search"]',
    title: "Jump anywhere",
    body: "Your profile and settings are a tap away. Head there anytime from the top bar.",
  },
  {
    id: "notifications",
    target: '[data-tour="notifications"]',
    title: "Stay in the loop",
    body: "Consent requests, updates and security alerts land here.",
  },
  {
    id: "theme",
    target: '[data-tour="theme"]',
    title: "Make it yours",
    body: "Switch between light and dark to suit your mood or lighting.",
  },
  {
    id: "done",
...
function TourOverlay({
  ...
  return createPortal(
    ...
    >
      ...
      {box ? (
        <div
          className="pointer-events-none fixed z-[201] rounded-2xl transition-all duration-300"
          style={{
      ...
      {/* Step card. Keyed per step so each one gets an entrance. Centering
          uses a grid wrapper, not translate classes — CSS owns transform. */}
      <div
        className={cn(
      ...
      >
        ...
        >
          <div className="flex items-start justify-between gap-3">
            <h2 className="kv-display text-base font-semibold tracking-tight text-ink">
              {step.title}
            </h2>
            {spotNumber > 0 && (
